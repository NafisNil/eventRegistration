...
class ParticipantTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/ParticipantType/Index', [
    ...
    {
        //
        return Inertia::render('Admin/ParticipantType/Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        ParticipantType::create($validatedData);
    ...
    {
        //
        return Inertia::render('Admin/ParticipantType/Edit', [
    ...
    public function update(Request $request, ParticipantType $participantType)
    {
        ...
        $participantType->update($validatedData);
        return redirect()->route('participant-types.index');
    }
