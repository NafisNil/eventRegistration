        ...
        <div className="world-habitat-day">
            <style>{`
                ...
                * { box-sizing: border-box; }
                ...
                .world-habitat-day .brand small { display: block; color: #ebd6a3; font-size: 10px; letter-spacing: 2px; font-weight: 700; }
                ...
                .world-habitat-day .field { display: flex; flex-direction: column; gap: 6px; }
                .world-habitat-day .field.full { grid-column: 1 / -1; }
                .world-habitat-day .field label { font-size: 13px; font-weight: 700; }
                .world-habitat-day .field input, .world-habitat-day .field select { padding: 13px; border: 1px solid #d9e5df; border-radius: 11px; font-family: inherit; font-size: 14px; }
                ...
                .world-habitat-day .footer-logo-badge { width: 40px; height: 40px; border-radius: 8px; background: linear-gradient(160deg, #f2c44b, #dbab30); color: #0d2b3f; display: grid; place-items: center; font-size: 15px; font-weight: 800; }
                .world-habitat-day .footer-brand-title { margin: 0; color: #ffffff; font-size: clamp(20px, 1.3vw, 34px); line-height: 1.1; font-weight: 800; }
                ...
                .world-habitat-day .footer-brand-copy { color: #95acb8; font-size: 16px; line-height: 1.8; max-width: 560px; margin: 8px 0 24px; }
                .world-habitat-day .footer-social-label { color: #7f98a6; font-size: 18px; font-weight: 700; margin-bottom: 12px; }
                .world-habitat-day .footer-social-list { display: flex; gap: 10px; }
                .world-habitat-day .footer-social-btn { width: 36px; height: 36px; border-radius: 13px; border: 1px solid rgba(172,196,210,.35); background: rgba(255,255,255,.03); color: #f1f6f9; display: grid; place-items: center; font-size: 34px; font-weight: 800; text-decoration: none; transition: transform 0.2s ease, border-color 0.2s ease; }
                .world-habitat-day .footer-social-btn:hover { transform: translateY(-2px); border-color: rgba(231,192,88,.62); }
                .world-habitat-day .footer-col-title { margin: 2px 0 16px; color: #ffffff; font-size: 14px; line-height: 1.1; font-weight: 800; }
                .world-habitat-day .footer-link-list { list-style: none; margin: 0; padding: 0; display: grid; gap: 10px; }
                .world-habitat-day .footer-link-list a { color: #a9bfcb; font-size: 14px; line-height: 1.25; text-decoration: none; font-weight: 500; }
                ...
                .world-habitat-day .footer-contact-card { display: flex; gap: 10px; align-items: center; padding: 12px 12px; border-radius: 16px; background: rgba(145,171,188,0.12); border: 1px solid rgba(172,196,210,.2); }
                .world-habitat-day .footer-contact-icon { width: 24px; height: 24px; border-radius: 12px; display: grid; place-items: center; background: rgba(168,191,205,.16); color: #dbab30; font-weight: 700; font-size: 20px; flex-shrink: 0; }
                .world-habitat-day .footer-contact-card small { display: block; color: #8ea5b2; font-size: 14px; line-height: 1.1; }
                .world-habitat-day .footer-contact-card strong { display: block; color: #f5fbff; font-size: 28px; letter-spacing: 1px; line-height: 1.12; }
                ...
                .world-habitat-day .footer-meta-left { display: inline-flex; align-items: center; gap: 12px; color: #8da4b2; font-size: 14px; }
                ...
                .world-habitat-day .footer-meta-link { color: #f0c54f; text-decoration: none; font-size: 18px; font-weight: 800; }
                ...
                .world-habitat-day .leadership-grid-secondary { max-width: 980px; grid-template-columns: repeat(2, minmax(0, 1fr)); }
                ...
                .world-habitat-day .leader-card-featured { width: min(400px, 100%); }
                .world-habitat-day .leader-card:hover { transform: translateY(-7px); box-shadow: 0 25px 55px rgba(22,59,47,.14); }
                .world-habitat-day .leader-photo { height: 430px; border-radius: 15px; background: linear-gradient(145deg, #dcece6, #c7ddd5); overflow: hidden; position: relative; }
                ...
                .world-habitat-day .support-categories { display: grid; gap: 36px; }
                .world-habitat-day .support-category-head { display: flex; align-items: center; gap: 14px; margin-bottom: 18px; }
                .world-habitat-day .support-category-index { width: 30px; height: 30px; border-radius: 10px; display: grid; place-items: center; font-size: 15px; font-weight: 800; color: #0f8d78; background: #e6f3ef; }
                .world-habitat-day .support-category-title { margin: 0; color: #123a57; font-size: clamp(24px, 1vw, 50px); line-height: 1.1; font-weight: 800; letter-spacing: -0.02em; }
                .world-habitat-day .support-category-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 15px; }
                .world-habitat-day .support-partner-card { min-height: 80px; display: flex; align-items: center; gap: 13px; background: #fff; border: 1px solid #d5e3e8; border-radius: 20px; padding: 12px 14px; box-shadow: 0 8px 22px rgba(19, 58, 87, 0.04); }
                .world-habitat-day .support-partner-logo { width: 50px; height: 50px; border-radius: 16px; background: linear-gradient(145deg, #0f4b60, #0f8d78); display: grid; place-items: center; flex-shrink: 0; padding: 10px; }
                .world-habitat-day .support-partner-logo img { width: 100%; height: 100%; object-fit: contain; filter: brightness(0) invert(1); opacity: 0.95; }
                .world-habitat-day .support-partner-body { min-width: 0; }
                .world-habitat-day .support-partner-name { color: #123a57; font-size: 15px; font-weight: 800; line-height: 1.3; overflow-wrap: anywhere; }
                ...
                .world-habitat-day .support-partner-sub { color: #738896; font-size: 13px; margin-top: 2px; line-height: 1.4; }
                ...
                @media (max-width: 650px) { .world-habitat-day .brand { font-size: 15px; } .world-habitat-day .hero { min-height: 88vh; } .world-habitat-day .hero-content { padding: 70px 20px 50px; } .world-habitat-day .meta { flex-direction: column; align-items: flex-start; } .world-habitat-day .count { margin-top: -30px; border-radius: 18px; } .world-habitat-day .count > div { padding: 15px 7px; } .world-habitat-day .count b { font-size: 25px; } .world-habitat-day .count small { font-size: 9px; } .world-habitat-day .cards, .world-habitat-day .guests, .world-habitat-day .grid { grid-template-columns: 1fr; } .world-habitat-day .item { grid-template-columns: 85px 1fr; gap: 10px; } .world-habitat-day .hero p { font-size: 16px; } .world-habitat-day .head h2 { font-size: 32px; } .world-habitat-day .support-categories { gap: 24px; } .world-habitat-day .support-category-head { align-items: flex-start; } .world-habitat-day .support-category-index { width: 42px; height: 42px; font-size: 20px; border-radius: 12px; } .world-habitat-day .support-category-title { font-size: 26px; } .world-habitat-day .support-category-grid { grid-template-columns: 1fr; gap: 12px; } .world-habitat-day .support-partner-card { min-height: 105px; padding: 12px; border-radius: 16px; } .world-habitat-day .support-partner-logo { width: 58px; height: 58px; border-radius: 14px; } .world-habitat-day .support-partner-name { font-size: 15px; } .world-habitat-day .support-partner-sub { font-size: 12px; } .world-habitat-day .leader-card { border-radius: 22px; padding: 14px 14px 20px; } .world-habitat-day .leader-photo { height: 330px; border-radius: 16px; } .world-habitat-day .leader-name { font-size: 22px; } .world-habitat-day .field.full { grid-column: auto; } }
                @media (max-width: 1100px) { .world-habitat-day .footer-inner { grid-template-columns: 1fr 1fr; } .world-habitat-day .footer-col-title { font-size: 30px; } .world-habitat-day .footer-link-list a { font-size: 22px; } .world-habitat-day .footer-meta-link { font-size: 24px; } }
                @media (max-width: 720px) { .world-habitat-day .site-footer { border-top-left-radius: 20px; border-top-right-radius: 20px; } .world-habitat-day .footer-inner { grid-template-columns: 1fr; gap: 24px; } .world-habitat-day .footer-logo-badge { width: 52px; height: 52px; font-size: 26px; } .world-habitat-day .footer-brand-title { font-size: 26px; } .world-habitat-day .footer-brand-copy { font-size: 14px; line-height: 1.7; } .world-habitat-day .footer-social-label { font-size: 20px; } .world-habitat-day .footer-social-btn { width: 26px; height: 36px; font-size: 14px; border-radius: 12px; } .world-habitat-day .footer-col-title { font-size: 24px; margin-bottom: 10px; } .world-habitat-day .footer-link-list a { font-size: 18px; } .world-habitat-day .footer-contact-card strong { font-size: 28px; } .world-habitat-day .footer-contact-card small { font-size: 13px; } .world-habitat-day .footer-meta-row { flex-direction: column; align-items: flex-start; } .world-habitat-day .footer-meta-link { font-size: 20px; } }
