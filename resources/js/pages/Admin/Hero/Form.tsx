  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 rounded-2xl border border-emerald-200 bg-white p-6 shadow-sm">
      <div className="space-y-2">
        ...
        {editor && (
          <div className="flex flex-wrap items-center gap-2 rounded-t-xl border border-emerald-200 bg-emerald-50/60 p-2 text-slate-700">
            <button
              type="button"
            ...
            <button
              ...
              className={`rounded px-2 py-1 text-xs font-semibold italic transition ${
                editor.isActive('italic') ? 'bg-emerald-700 ' : 'hover:bg-emerald-100 '
              }`}
            >
              I
            </button>
