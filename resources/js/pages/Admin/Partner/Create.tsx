...
export default function Create({ partnershipCategories = [] }: CreateProps) {
  const handleSubmit = (formData: FormData) => {
    router.post('/partners', formData, {
      forceFormData: true,
      preserveScroll: true,
      onSuccess: () => {
        Swal.fire({
          ...
          text: 'The partner was created successfully.',
          timer: 2000,
    ...
    <>
      ...
      <div className="space-y-4">
        <div className="rounded-2xl bg-linear-to-r from-emerald-900 via-emerald-800 to-teal-900 p-6 text-white shadow-sm">
          ...
          <h1 className="mt-2 text-2xl font-bold">Create Partner</h1>
          <a href="/partners" className="text-sm text-emerald-200 hover:underline">
            Back to list
          </a>
        </div>
