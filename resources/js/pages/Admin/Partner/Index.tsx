...
export default function Index({ partners = [] }: IndexProps) {
      ...
      router.delete(`/partners/${id}`, {
        ...
        onSuccess: () => {
          Swal.fire({
            ...
            text: 'The partner was deleted successfully.',
            timer: 2000,
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between gap-3 rounded-2xl bg-linear-to-r from-emerald-900 via-emerald-800 to-teal-900 p-6 text-white shadow-sm">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-bold">Partners</h1>
          </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-emerald-200 bg-white shadow-sm">
          {partners.length === 0 ? (
            <div className="p-8 text-center text-slate-500">No partners found yet.</div>
          ) : (
